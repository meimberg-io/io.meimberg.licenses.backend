...
public class Manufacturer {
  ...
  public Manufacturer url(String url) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, manufacturer.id) &&
        ...
        equalsNullable(this.url, manufacturer.url) &&
        equalsNullable(this.description, manufacturer.description);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, hashCodeNullable(url), hashCodeNullable(description));
  }
