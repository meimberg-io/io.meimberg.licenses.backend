...
public class DepartmentCreateRequest {
  ...
  public DepartmentCreateRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DepartmentCreateRequest departmentCreateRequest = (DepartmentCreateRequest) o;
    return Objects.equals(this.name, departmentCreateRequest.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class DepartmentCreateRequest {\n");
